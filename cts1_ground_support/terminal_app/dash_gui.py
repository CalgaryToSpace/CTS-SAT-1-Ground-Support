...
@callback(
    ...
    Input("input-log_filename-suffix-tag", "value"),
...
def update_stored_command_preview(
    ...
    log_filename_suffix_tag: str | None,
    ...
    *every_arg_value: str,
    ...
    if log_filename_suffix_tag == "":
        log_filename_suffix_tag = None
    ...
    return generate_telecommand_preview(
        ...
        log_filename_suffix_value=log_filename_suffix_tag,
        ...
        html.Div(
            dbc.FormFloating(
                [
                    dbc.Input(
                        type="text",
                        id="input-log_filename-suffix-tag",
                        placeholder="File Name to log the response",
                        style={"fontFamily": "monospace"},
                    ),
                    dbc.Label(
                        "File Name to store TCMD response, MAX 32 characters",  # Update as needed from Firmware
